...
/* Generation options: */
#ifndef __model_mkALU_h__
#define __model_mkALU_h__
...
/* Class declaration for a model of mkALU */
class MODEL_mkALU : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkALU *mkALU_instance;
...
#endif /* ifndef __model_mkALU_h__ */
