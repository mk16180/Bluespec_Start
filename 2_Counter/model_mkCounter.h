...
/* Generation options: */
#ifndef __model_mkCounter_h__
#define __model_mkCounter_h__
...
/* Class declaration for a model of mkCounter */
class MODEL_mkCounter : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkCounter *mkCounter_instance;
...
#endif /* ifndef __model_mkCounter_h__ */
