...
/* Generation options: */
#ifndef __model_mkHello_h__
#define __model_mkHello_h__
...
/* Class declaration for a model of mkHello */
class MODEL_mkHello : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkHello *mkHello_instance;
...
#endif /* ifndef __model_mkHello_h__ */
